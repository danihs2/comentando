...
function Footer () {
  return (
    <footer
    className="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left mt-5">
    <div
    ...
    <div className="mx-6 py-10 text-center md:text-left">
        ...
        <div className="">
            ...
            <p>
            Proyecto escolar, puedes utilizar este proyecto para cualquier cosa que quierashacer c:
            </p>
        </div>
        <div>
            <h6
